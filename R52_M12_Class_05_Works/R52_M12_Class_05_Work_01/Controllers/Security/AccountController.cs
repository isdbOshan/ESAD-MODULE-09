...
using R52_M12_Class_05_Work_01.ViewModels.Identity;
...
namespace R52_M12_Class_05_Work_01.Controllers.Security
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public AccountController(UserManager<IdentityUser> userManager, IConfiguration config, DeviceDbContext db)
        {
